    ...
    return (
        <div className='bg-white h-screen flex flex-col justify-center items-center'>
            ...
            <h3 class="text-gray-800 text-2xl text-center px-10">Et has minim elitr intellegat. Mea aeterno eleifend antiopam ad, nam no suscipit quaerendum.
                 ...
                 <div className="py-3 px-3 bg-blue-500 text-gray-100 text-1xl hover:bg-blue-400  " id="delete-btn">Know More </div>

                  <div class="bg-gray-600 bg-opacity-50 absolute inset-0 flex justify-center items-center" id="overlay">
                  ...
                  <div class="mb-3 pt-0">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" id="close-modal" fill="none" viewBox="0 0 24 24" stroke="currentColor">
